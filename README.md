...
## Было не так сложно, скорей интересно!

Совместно с Таней провели проверку стиля кода друг у друга.
Теперь мы понимаем, как красиво и правильно оформлять читаемый 
программный код

Приложение достаточно простое и умеет рассчитывать доход депозита
на заданный промежуток времени при разных видах процентов!
